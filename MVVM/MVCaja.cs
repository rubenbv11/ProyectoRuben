...
namespace ProyectoRuben.MVVM
{
    ...
    public class MVCaja : MVBase
    {
        ...
        /// <summary>
        /// Opciones de método de pago disponibles en el ComboBox de la caja.
        /// Deben coincidir con el enum de la tabla factura en BD.
        /// </summary>
        public List<string> MetodoPagoItems { get; } = new List<string>
        {
                      ...
                      IProductoRepository productoRepository)
        {
            ...
            CargarReservaCommand = new RelayCommand(async _ =>
            {
                try { await CargarReservaAsync(); }
        ...
        private async Task CargarReservaAsync()
        {
            ...
            {
                MensajeAdvertencia.Mostrar("Validación", "Ingresa un ID de reserva válido.");
                return;
            }
