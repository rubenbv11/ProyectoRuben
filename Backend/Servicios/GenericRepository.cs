...
{
    /// <summary>
    /// Repositorio gen�rico que implementa <see cref="IGenericRepository{T}"/> para EF Core.
    ...
    {
        /// <summary>
        /// Instancia del contexto usada por el repositorio.
        /// </summary>
        protected readonly GestioninventarioyserviciosContext _context;
        ...
        public GenericRepository(GestioninventarioyserviciosContext context, ILogger logger)
        {
            _context = context;
        ...
        /// �salo para componer consultas, opcionalmente sin tracking e incluyendo propiedades de navegaci�n.
        /// </summary>
        /// <param name="asNoTracking">Si es true, la consulta devuelve <c>AsNoTracking()</c>.</param>
        /// <param name="includes">Propiedades de navegaci�n a incluir.</param>
        ...
        /// <summary>
        /// Busca una entidad por clave primaria de forma as�ncrona usando <c>FindAsync</c>.
        /// </summary>
        ...
        /// <param name="cancellationToken">Token de cancelaci�n.</param>
        /// <param name="includes">Propiedades de navegaci�n a incluir.</param>
        /// <returns>Primera entidad que cumple la condici�n o null.</returns>
        ...
        /// <summary>
        /// Este m�todo busca la primera entidad que cumple con el filtro proporcionado.
        /// </summary>
        /// <param name="filter">Expresi�n booleana que filtra la lista</param>
        ...
        {   
            ...
            {
                _logger.LogError(ex, "Error al obtener la primera entidad de tipo {EntityName}", typeof(T).FullName);
                throw new DataAccessException($"Error al obtener la primera entidad de tipo {typeof(T).FullName}", ex);
            }
        }
        ...
        {
            // AsNoTracking evita que el ChangeTracker acumule entidades en memoria
        ...
        /// <summary>
        /// A�ade una entidad y persiste los cambios en la base de datos.
        /// Las excepciones se registran y se relanzan.
        /// </summary>
        /// <param name="entity">Entidad a a�adir.</param>
        /// <param name="cancellationToken">Token de cancelaci�n.</param>
        public async Task AddAsync(T entity, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                _logger.LogInformation("Entidad de tipo {EntityType} a�adida correctamente.", typeof(T).FullName);
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, "Error al a�adir la entidad de tipo {EntityType}.", typeof(T).FullName);
                throw new DataAccessException($"Error al a�adir la entidad de tipo {typeof(T).FullName}", ex);
            }
        }

        /// <summary>
        /// A�ade m�ltiples entidades y persiste los cambios en la base de datos.
        /// Las excepciones se registran y se relanzan.
        /// </summary>
        /// <param name="entities">Entidades a a�adir.</param>
        /// <param name="cancellationToken">Token de cancelaci�n.</param>
        public async Task AddRangeAsync(IEnumerable<T> entities, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                _logger.LogInformation("Se a�adieron correctamente {Count} entidades del tipo {EntityType}.", count, typeof(T).FullName);
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, "Error al a�adir un conjunto de entidades del tipo {EntityType}.", typeof(T).FullName);
                throw new DataAccessException($"Error al a�adir un conjunto de entidades del tipo {typeof(T).FullName}", ex);
            }
        }
        ...
        public async Task RemoveByIdAsync(object id)
        {
            try
            {
                ...
                if (entity == null)
                {
                    _logger.LogWarning("Entidad de tipo {EntityType} con id {Id} no encontrada para eliminaci�n.", typeof(T).FullName, id);
                    return;
                }
        ...
        /// <summary>
        /// Guarda todos los cambios pendientes en el contexto a la base de datos de forma as�ncrona.
        /// </summary>
        ...
        /// <remarks>
        /// Este m�todo persiste todas las operaciones de agregar, actualizar y eliminar que se hayan 
        /// realizado desde el �ltimo SaveChangesAsync o desde la creaci�n del contexto.
        /// 
        /// Maneja espec�ficamente:
        /// - DbUpdateConcurrencyException: cuando ocurren conflictos de concurrencia
        /// - DbUpdateException: cuando hay errores de actualizaci�n de base de datos
        /// - Exception: cualquier otro error inesperado
        /// 
        /// En aplicaciones con alta concurrencia, se recomienda implementar l�gica de reintentos
        ...
        public async Task<int> SaveChangesAsync()
        {
            ...
            {
                _logger.LogError(ex, "Error de actualizaci�n en la base de datos al guardar los cambios");
    ...
    /// <summary>
    /// Excepci�n personalizada para errores de acceso a datos.
    /// Encapsula errores espec�ficos de Entity Framework Core y proporciona contexto adicional.
    /// </summary>
    /// <remarks>
    /// Esta excepci�n se utiliza para envolver todos los errores de acceso a datos,
    /// permitiendo un manejo consistente de errores en capas superiores de la aplicaci�n.
    /// Siempre incluye la excepci�n original como InnerException para facilitar el diagn�stico.
    /// </remarks>
    public class DataAccessException : Exception
    {
        /// <summary>
        /// Inicializa una nueva instancia de DataAccessException con un mensaje espec�fico.
        /// </summary>
        ...
        /// <summary>
        /// Inicializa una nueva instancia de DataAccessException con un mensaje y la excepci�n interna.
        /// </summary>
        /// <param name="message">Mensaje descriptivo del error.</param>
        /// <param name="innerException">Excepci�n original que caus� este error.</param>
